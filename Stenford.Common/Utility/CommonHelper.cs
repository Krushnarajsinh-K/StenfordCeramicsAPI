...
using OtpNet;
using UniqueITAdminPanel.Common;
using System;
...
namespace UniqueITAdminPanel.Common.Utility
{
    public static class CommonHelper
    {
        public static string GetFullImagePath(string imagePartialUrl)
        {
            if (string.IsNullOrWhiteSpace(imagePartialUrl))
            {
                return string.Empty;
            }
            return ConstantMessage.ImageBaseUrl+ imagePartialUrl;
        }
       

        public static string FormatFileName(string fileNameWithSpaces)
        {
            if (string.IsNullOrWhiteSpace(fileNameWithSpaces))
                return string.Empty;
        ...
        public static bool InsertFileAfterRename(IFormFile file, string path, string updateName)
        {
            try
            {
